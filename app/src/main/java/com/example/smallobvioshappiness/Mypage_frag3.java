...
public class Mypage_frag3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.mypage_frag3, container, false);

        Log.d("text", "Mypage_frag3 Start");
    ...
    public void initUI(ViewGroup rootView) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() { //리사이클러뷰 생성
                recyclerView = rootView.findViewById(R.id.mypage_frag3_recyclerview);
    ...
    public void add_post(){
        String url = "http://dev.sbch.shop:9000/app/users/interest";
